            ...
            <div className="w-full max-w-xl px-6 pb-8">
                <div className="w-full flex items-center justify-between py-6">
                    <div className="flex items-center">
                        ...
                        <h1 className="text-2xl font-extrabold font-['NanumSquareRound']">개인 정보 관리</h1>
                    </div>
                    <button>
                        <div className="w-12 h-12 overflow-hidden rounded-full">
                            <Image src="/img/settings.png" alt="User profile" width={60} height={60} />
                        </div>
                    </button>
                </div>
                ...
                <div className="w-full space-y-6">
                    {[
                        ...
                        <div key={index} className="flex items-center">
                            <div className="w-32 text-xl font-normal font-['NanumSquareRound']">{item.label}</div>
                            <div className="text-xl font-normal font-['NanumSquareRound']">{item.value}</div>
                        </div>
                    ))}
                </div>
